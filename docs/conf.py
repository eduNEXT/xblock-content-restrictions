...
"""
xblock-content-restrictions documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'xblock-content-restrictions',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edunext/xblock-content-restrictions",
...
#
# html_title = 'xblock-content-restrictions v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'content_restrictions'),
                os.path.join(root_path, 'content_restrictions/migrations')])
