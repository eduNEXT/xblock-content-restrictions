...
class XblockContentRestrictions(StudioContainerWithNestedXBlocksMixin, StudioEditableXBlockMixin, XBlock):
    ...
    seb_browser_keys = List(
        ...
        help=_(
            "List of browser keys that are allowed to be accessed from Safe Exam Browser. This "
            "keys are generated by SEB."
        ),
        scope=Scope.settings,
        enforce_type=True,
        default=[],
    ...
    seb_config_keys = List(
        ...
        help=_(
            "List of config keys that are allowed to be accessed from Safe Exam Browser. This "
            "keys are generated by SEB."
        ),
        scope=Scope.settings,
        enforce_type=True,
    ...
    seb_whitelist_paths = List(
        ...
        help=_(
            ...
            "Browser. To allow a restriction at the unit level it is necessary to maintain "
            'the "courseware" path in the list.'
        ),
        scope=Scope.settings,
        enforce_type=True,
        default=["courseware"],
